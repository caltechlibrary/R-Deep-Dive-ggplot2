...
the same basic information (the "structure") bout this data frame. If we want 
to look at all the data in a table format, click on the **name** of the data 
frame in the Environment tab. This will open up a new object tab in the upper 
left, next to this window.
...
2. "aes()": these are the aesthetic mappings for the plot - how we are visually representing the data variables. The basic ones used here are:
